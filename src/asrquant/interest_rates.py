...
def year_fraction(start: date | datetime | str, end: date | datetime | str, convention: str = "ACT/365F") -> float:
    ...
    Supports ACT/360, ACT/365F, ACT/ACT ISDA, 30/360 and 30E/360.
    """
    from .market_conventions import year_fraction as _market_year_fraction
    return float(_market_year_fraction(start, end, convention))
...
# ASRQuant 1.3 market-infrastructure layer. Imported after the core curve
# definitions to preserve the 1.x module surface without circular startup work.
from .market_conventions import (
    BusinessDayConvention, DayCount, StubConvention, Compounding, Frequency, Calendar, Schedule,
)
from .rates_instruments import Deposit, FRA, FixedRateBond, InterestRateSwap, OIS, InstrumentRiskResult
from .curve_builder import CurveBuilder, CurveBuildResult
from .curve_risk import CurveRiskResult, curve_risk
from .rates_pnl import RatePnLExplain, pnl_explain, zero_coupon_carry_roll
...
__all__ = [
    ...
    "BusinessDayConvention", "DayCount", "StubConvention", "Compounding", "Frequency", "Calendar", "Schedule",
    "Deposit", "FRA", "FixedRateBond", "InterestRateSwap", "OIS", "InstrumentRiskResult",
    "CurveBuilder", "CurveBuildResult", "CurveRiskResult", "curve_risk",
    "RatePnLExplain", "pnl_explain", "zero_coupon_carry_roll",
]
