...
from . import regimes
from . import performance_attribution as performance
from . import model_selection
from . import covariance
from . import randomness as random
...
# Stable canonical verbs are attached to domain namespaces without removing
# lower-level 1.x functions used by existing notebooks.
...
__all__ = [
    ...
    "data", "backtesting", "ml", "options", "stochastic", "mc", "approx", "rates", "vol", "research", "discovery", "hypotheses", "alpha", "risk", "microstructure", "factors", "contracts", "trading", "validation", "scenarios", "credit", "calibration", "sensitivities", "diagnostics", "costs", "dependence", "regimes", "performance", "model_selection", "covariance", "random", "register",
