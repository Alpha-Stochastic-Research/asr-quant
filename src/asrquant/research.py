...
from .discovery import (
    ...
    ResearchCandidate,
    ResearchObservation,
    catalog as idea_catalog,
    from_literature as discover_from_literature,
    weekly as discover,
)
from .research_ops import WeeklyResearchCycle, weekly_cycle
...
__all__ = [
    ...
    "ResearchObservation", "ResearchCandidate", "ResearchBoard", "discover", "ideas", "idea_catalog", "discover_from_literature", "WeeklyResearchCycle", "weekly_cycle",
    "PortfolioSpec", "HypothesisTestResult", "RobustnessResult", "DecisionResult", "ResearchProject",
]

# ASRQuant 1.3 experiment manifests and cross-domain reporting.
from .experiments import Experiment, ExperimentRegistry
from .research_report import ResearchReport

# ASRQuant 1.3 research artifact lineage.
from .research_graph import ResearchArtifact, ResearchGraph
