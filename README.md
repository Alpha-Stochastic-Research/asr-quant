...
> **Release candidate: `1.3.0rc1`** — pre-release package for independent `pytest` validation before the final 1.3.0 publication.
...
For this `1.3.0rc1` source candidate and its pytest suite:
...
ASRQuant targets Python **3.10–3.14** through the repository compatibility matrix.
...
See `CITATION.cff` for the software citation metadata. The manuscript is intentionally not included in this pre-release candidate.
