# Validation strategy for ASRQuant 1.1.0
...
The local validation report is `VALIDATION_v1.1.0.md`. A live deployment must additionally produce a passing `ProductionReadinessReport` for its own environment.
