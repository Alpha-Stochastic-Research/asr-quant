...
ASRQuant 1.1.0 adds a conservative research-discovery layer for the ASR Research and Analyst teams. Its job is to transform evidence into **falsifiable research candidates**. It never treats an automatically generated idea as a proven novelty claim.
