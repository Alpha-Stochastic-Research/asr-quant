# Deployment guide for ASRQuant 1.1.0

## Status

`1.1.0` is the current stable public-API release. Stable software status does **not** certify any particular live-capital deployment. Live authorization remains deployment-specific and fail-closed.
